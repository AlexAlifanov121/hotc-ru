  ...
  window.HOTC_PROJECTS = [
    {
      ...
      pricing: {
        ...
        plan: '10% + AED 5,000 admin fee on booking · 15% + 4% DLD within 30 days of SPA · 15% Sep 2026 · 10% Sep 2027 · 50% on completion · No post-handover',
        planRu: '10% + AED 5 000 админ-сбор при бронировании · 15% + 4% DLD в течение 30 дней после SPA · 15% сентябрь 2026 · 10% сентябрь 2027 · 50% при сдаче · Без post-handover'
      },
    ...
    },
    {
      ...
      whyRu: 'Доступен только через закрытые resale-каналы. Pritzker-происхождение + готовый объект. Без off-plan риска.',
      risk: 'Ready property — full transfer immediately. Resale liquidity is private channel only.',
      riskRu: 'Готовый объект — полная оплата сразу при передаче. Ликвидность resale — только через приватные каналы.',
    ...
    },
    {
      ...
      pricing: {
        ...
        plan: '5% on booking · 15% + 4% DLD on SPA · 10% September 2026 · 70% on completion · No post-handover',
        planRu: '5% при бронировании · 15% + 4% DLD при подписании SPA · 10% сентябрь 2026 · 70% при сдаче · Без post-handover'
      },
...

    {
      ...
      pricing: {
        ...
        plan: '10% + 2% admin + AED 3,150 on booking · 10% Jan 2027 · 5% Aug 2027 · 5% Apr 2028 · 10% Nov 2028 · 60% on handover Q1 2030 · No post-handover',
        planRu: '10% + 2% admin + AED 3 150 при бронировании · 10% янв 2027 · 5% авг 2027 · 5% апр 2028 · 10% ноя 2028 · 60% при сдаче Q1 2030 · Без post-handover'
      },
      ...
      riskRu: 'Длинный горизонт и ограниченная ликвидность resale на Saadiyat. Лучше удерживать от 5 лет.',
...

    {
      ...
      pricing: {
        ...
        plan: 'Apartments: 5% + 2% ADM + admin on booking · 20% on SPA · 75% over 3 years (6.25% every 3 months) · Villas/Mansions: similar tiered plan · No post-handover',
        planRu: 'Квартиры: 5% + 2% ADM + админ при бронировании · 20% при SPA · 75% в течение 3 лет (6.25% каждые 3 мес) · Виллы/Особняки: аналогичная ступенчатая схема · Без post-handover'
      },
      ...
      amenitiesRu: ['Приватный выход к пляжу','Пешая доступность до публичных садов','Соседство с Ghantout Racing & Polo Club','Прямой выезд на Sheikh Zayed Road','Брендированные интерьеры Jacob & Co','Консьерж от Ohana'],
      ...
      noteRu: 'Брендированные интерьеры Jacob & Co, приватный пляж, особняки + квартиры.'
    },

    {
      ...
      pricing: {
        ...
        plan: '4% DLD Waiver · 10% + AED 3,000 admin on booking · 10% +180d · 5% +360d · 5% +540d · 5% +720d · 5% +900d · 60% on completion · No post-handover',
        planRu: '4% DLD оплачивает девелопер · 10% + AED 3 000 при бронировании · 10% +180д · 5% +360д · 5% +540д · 5% +720д · 5% +900д · 60% при сдаче · Без post-handover'
      },
...

    {
      ...
      pricing: {
        ...
        plan: '20% + 4% DLD + AED 3,150 OQOOD on booking · 10% Dec 2026 · 10% Jun 2027 · 10% Dec 2027 · 10% Jun 2028 · 40% on completion Q4 2029 · No post-handover',
        planRu: '20% + 4% DLD + AED 3 150 OQOOD при бронировании · 10% дек 2026 · 10% июнь 2027 · 10% дек 2027 · 10% июнь 2028 · 40% при сдаче Q4 2029 · Без post-handover'
      },
      ...
      riskRu: 'Публичной информации мало — цены и детали юнитов раскрываются только на закрытых показах в галерее.',
...

    {
      ...
      whyRu: 'Тот же дизайн-код Beyond, более спокойный вход. Трёхбашенная композиция чисто торгуется между юнитами.',
...

    {
      ...
      whyRu: 'Брендированные Four Seasons — узкая глобальная когорта. Mubadala как государственный девелопер underwrite\'ит Saadiyat как destination.',
      ...
      noteRu: 'Брендированные резиденции Four Seasons на Saadiyat Beach.'
    },

    {
      ...
      briefRu: 'Cheval Residences Dubai Islands — первый сервисный residential-проект бренда в ОАЭ. Cheval Collection держит сервисные резиденции в Лондоне, Эдинбурге, Женеве — с репутацией ненавязчивого пятизвёздочного сервиса дома. Dubai Islands — новая prime-локация с малым числом name-brand операторов. Всего 99 юнитов, в верхних линиях очень малые серии (всего 8 трёхспальных).',
      ...
      whyRu: 'Европейский serviced-бренд входит в ОАЭ в правильном цикле. Серия 99 юнитов остаётся компактной. Линия 3BD (8 юнитов) — коллекционная.',
      risk: 'Dubai Islands resale market is still maturing — brand premium does the heavy lifting.',
      riskRu: 'Resale-рынок Dubai Islands ещё созревает — премия за бренд берёт основную нагрузку.',
      ...
      noteRu: 'Сервисные резиденции Cheval Collection · 99 юнитов · Q1 2029.'
    },

    {
      ...
      pricing: { bands: [{ type:'Residences', size:'Multiple types', price:'POA' }], plan:'20% + 4% DLD + AED 3,150 OQOOD on booking · 5% Nov 2026 · 5% Apr 2027 · 10% Sep 2027 · 10% Feb 2028 · 50% on completion Q3 2030 · No post-handover', planRu:'20% + 4% DLD + AED 3 150 OQOOD при бронировании · 5% ноя 2026 · 5% апр 2027 · 10% сен 2027 · 10% фев 2028 · 50% при сдаче Q3 2030 · Без post-handover' },
      ...
      noteRu: 'Брендированные residential Jumeirah Hotels & Resorts от Meraas.'
    },
...

    {
      ...
      ], plan:'10% + 4% DLD + AED 5,250 + OQOOD on booking · 10% on SPA (30 days) · 10% +5 months SPA · 10% +10 months SPA · 60% on handover Q4 2026 · No post-handover', planRu:'10% + 4% DLD + AED 5 250 + OQOOD при бронировании · 10% при SPA (30 дней) · 10% +5 мес SPA · 10% +10 мес SPA · 60% при сдаче Q4 2026 · Без post-handover' },
      ...
      riskRu: 'Resale-рынок Meydan волатильнее, чем Palm / Saadiyat. Горизонт 3–5 лет на созревание комплекса.',
...

    {
      ...
      pricing: { bands: [{ type:'Residences', size:'Multiple types', price:'POA' }], plan:'10% on booking · 4% DLD + AED 1,155 on SPA · 10% within 6m SPA · 10% within 12m SPA · 70% on completion Q1 2027 · No post-handover', planRu:'10% при бронировании · 4% DLD + AED 1 155 при SPA · 10% в 6 мес · 10% в 12 мес · 70% при сдаче Q1 2027 · Без post-handover' },
...

    {
      ...
      pricing: { bands: [{ type:'Villa 26 — Crown Jewel', size:'Largest plot', price:'Resale (private)' }], plan:'100% + 4% DLD · Full payment · No post-handover', planRu:'100% + 4% DLD · Полная оплата · Без post-handover' },
...

    {
      ...
      pricing: { bands: [{ type:'Residences', size:'Multiple types', price:'POA' }], plan:'10% + 4% DLD + AED 1,040 fees on booking · 10% Jul 2026 · 5% Jan 2027 · 5% May 2027 · 5% Sep 2027 · 5% Jan 2028 · 5% May 2028 · 5% Sep 2028 · 50% on completion Q1 2029 · No post-handover', planRu:'10% + 4% DLD + AED 1 040 при бронировании · 10% июль 2026 · 5% янв 2027 · 5% май 2027 · 5% сен 2027 · 5% янв 2028 · 5% май 2028 · 5% сен 2028 · 50% при сдаче Q1 2029 · Без post-handover' },
...

    {
      ...
      pricing: { bands: [{ type:'Residences', size:'Multiple types', price:'POA' }], plan:'AED 30,000 on booking · 80% + 4% DLD on SPA · 20% within 1 month from completion Q3 2026 · Alternative plan: 20% discount for 1-month post-handover · Or 1-year post-handover option', planRu:'AED 30 000 при бронировании · 80% + 4% DLD при SPA · 20% в течение 1 мес после сдачи Q3 2026 · Альтернатива: 20% скидка за 1-месячный post-handover · Или опция 1-летнего post-handover' },
...

    {
      ...
      pricing: {
        ...
        plan: '10% + 5% DIFC registration on booking · 5% +3m SPA · 5% +6m SPA · 10% +12m SPA · 10% +18m SPA · 60% on completion Q4 2028 · No post-handover',
        planRu: '10% + 5% регистрация DIFC при бронировании · 5% +3 мес SPA · 5% +6 мес · 10% +12 мес · 10% +18 мес · 60% при сдаче Q4 2028 · Без post-handover'
      },
